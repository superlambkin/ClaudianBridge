...
| 2 | 読み上げ章は **📢 ヘッダー → 🎯 結論 → 🎁 成果物 → 🔜 次のアクション提案** の 4 章。検証結果・参照文献は読まない | 質問 2 |
...
| 3 | 見出し `🎁 成果物` | `成果物です。` | 同上 |
| 4 | 見出し `🔜 次のアクション提案` | `次のアクション提案です。` | 同上 |
...
- テーブル（検証結果・成果物テーブル・次のアクション提案テーブル・参照文献）
- ✅ 検証結果 章（見出し自体も読まない）
- 📚 参照文献 章
...
| # | テスト | ファイル |
|:-:|------|---------|
| 1 | 完了報告 DOM → 期待スクリプト（4 章 + 見出し語） | `tests/features/tts/report-script.test.ts`（新規） |
| 2 | 検証結果・参照文献・テーブルが含まれないこと | 同上 |
| 3 | サマリー欠落章の読み飛ばし | 同上 |
