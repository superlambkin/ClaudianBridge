...
> ⚠️ **注意**: 本書はテンプレートのプレースホルダーです。Claudian Bridge は Obsidian の設定タブ UI を中心に設計されており、独立した Web 画面（ルーティング付き）は持たないため、実際の画面構成は [[../22_設定画面設計|設定画面設計]] を参照してください。
...
| # | 画面 ID | 画面名称 | 実装箇所 | 状態 |
|---|---------|----------|---------|:----:|
| 1 | Screen_01 | 設定タブ | [[../22_設定画面設計\|22_設定画面設計]] | ✅ |
...
| ファイル | 説明 |
|------|------|
| [[../22_設定画面設計\|22_設定画面設計.md]] | 設定タブ UI の詳細設計 |
