...
本書は Claudian Bridge v0.8.0 の主要状態（QuotaStatus「使用量制限の状態」 / Office StageStatus「Office変換の進捗状態」 / 選択ウォッチャー / Chroma Browser）を [[80_POC_Projects/POC_017_ClaudianBridge/02_設計文書/02_シーケンス図|シーケンス図]] と対にして定義する。実コードを SSOT（唯一の情報源）とする。
...
- [[80_POC_Projects/POC_017_ClaudianBridge/02_設計文書/02_シーケンス図|シーケンス図]]
