...
> ⚠️ **v3.8.0**: 配下 8 文書を As-Built **v0.49.1（F001〜F051・欠番除き 38 機能）** へ同期（2026-09-15）。**F006 11 タブ化**、**F011 5 プロバイダ・Zhipu 純 TS 化（F048）**、**OpenVPN 統合（F041-F047）**、**Outputs ミラーリング（F049・F041 衝突解消）**、**🤖 Think モード（F039/F040）**、**💬 チャット読上げハイライト（F050）**、**📄 MD 画面 Add to TTS ボタン（F051）**、**v0.49.1 ホットフィックス**を反映。テスト総数 **1362 件 PASS**。
...
- [x] 子ドキュメント 8 件すべてを記入（00/01 は 2026-09-15 As-Built v0.49.1 同期）
- [x] F-番号機能（F001〜F051・F029/F034/F035/F036/F037 欠番の **38 件**）
- [x] 少なくとも 3 つの非機能要件観点（8 観点 + クランプ表 + 設計制約 + **NFR-22〜NFR-30**）
- [x] ユースケース図がコアフローをカバー（外部コンポーネント **9 件** 含む）
- [x] F 番号機能（F001〜F051・F029/F034/F035/F036/F037 欠番の 38 件）に整合した User Story（US01〜US51・US29/US34/US35/US36/US37 欠番の **42 件**）
- [x] 合格 [[00_Vault管理/MD生成ルール|MD 規範]] 5 観点のセルフチェックに合格
- [x] テスト総数 **1362 件 PASS**・**v0.49.1 ホットフィックス**を全 AC に反映
...
*📋 01_要件定義 フェーズインデックス v3.8.0 · MiuMiu 🐾 · 2026-09-15 As-Built v0.49.1 対応*
